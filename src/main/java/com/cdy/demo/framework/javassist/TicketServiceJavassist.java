package com.cdy.demo.framework.javassist;

import javassist.*;

import java.lang.reflect.Constructor;

public class TicketServiceJavassist {
    ...
    private static void createProxy() throws Exception
    {
    	...
    	CtClass cc = pool.makeClass("com.cdy.demo.framework.javassist.TicketServiceProxy");
    	
    	//设置接口
    	CtClass interface1 = pool.get("com.cdy.demo.framework.javassist.TicketService");
    	cc.setInterfaces(new CtClass[]{interface1});
    	
    	//设置Field
    	CtField field = CtField.make("com.cdy.demo.framework.javassist.TicketServiceImpl station;", cc);
    	
    	cc.addField(field);
    	
    	CtClass stationClass = pool.get("com.cdy.demo.framework.javassist.TicketServiceImpl");
